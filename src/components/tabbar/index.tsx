...
import { type Props as IndicatorProps, TabBarIndicator } from './tabbar-indicator';
import { type Props as TabBarItemProps, TabBarItem } from './tabbar-item';
import type {
    Event,
    Layout,
    LocaleDirection,
...
const getScrollAmount = <T extends Route>({
    ...
    const centerDistance = Array.from({
        ...
        return (
            total + (i > 0 ? gap ?? 0 : 0) + (navigationState.index === i ? tabWidth / 2 : tabWidth)
        );
    }, paddingInitial);
