...
type OPTION = {
    ...
    style: ViewStyle | undefined | null;
...
export default class Toast {
    ...
    static toast(textContent: string = '未知信息', duration: number = 2000) {
        // toast蒙层默认透明
        const backgroundColor = toastOption?.backgroundColor || 'rgba(0,0,0,0)';
        // toast背景色默认值
        const toastViewBackgroundColor = toastOption?.style?.backgroundColor || 'rgba(0,0,0,0.8)';
